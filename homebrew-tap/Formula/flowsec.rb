class Flowsec < Formula
  ...
  resource "anthropic" do
    url "https://files.pythonhosted.org/packages/0c/7a/8c64e9ba12b16d5d1c64e0fc9da1f32cbf6742f14fe2ad943f83a2ed8639/anthropic-0.106.0-py3-none-any.whl"
    sha256 "d0e4a7448e54c3942833cee5b3de5f1b31289fd49999bfbcc2ec0c0acaddf75f"
  end
  ...
  resource "pygithub" do
    url "https://files.pythonhosted.org/packages/77/aa/81a5506f089a26338bff17535e4339b3b22049ebd1bcdeff756c4d7a7559/pygithub-2.9.1-py3-none-any.whl"
    sha256 "2ec78fca30092d51a42d76f4ddb02131b6f0c666a35dfdf364cf302cdda115b9"
  end
  ...
  # ── compiled extensions (built from source) ─────────────────────────────────
  ...
  test do
    assert_match "usage", shell_output("#{bin}/flowsec --help 2>&1").downcase
    assert_match "scan", shell_output("#{bin}/flowsec --help 2>&1")
  end
end
